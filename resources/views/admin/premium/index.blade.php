<x-app-layout title="Admin - Premium">
    <x-slot name="header">
                    ...
                    <table class="w-full text-sm sm:text-base rounded-md overflow-hidden">
                        <thead>
                            <tr class="h-10 bg-[#ff7100] text-white divide-x-2 divide-white">
                                <th class=" px-1 sm:px-2 py-1">Nama Paket</th>
                ...
                x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
                    ...
                    <div class="w-full max-w-[720px] max-h-[calc(100vh-16px)] bg-white pb-6 text-left rounded-md flex flex-col gap-4 relative border-2 border-[#ff7100]">
                        <div class=" pt-6 pb-3 bg-[#ff7100] text-white z-30">
                            <h2 class=" px-6 text-2xl font-bold">Edit Paket Premium</h2>
                        ...
                        <form :action="`{{ route('package.update', ['package' => '/']) }}/${editData.id}`" method="POST">
                            @csrf
                            @method('PUT')
                            <div class=" space-y-3 px-6">
                                <x-admin.component.textinput title="Nama Paket" placeholder="Masukkan nama Paket..." name="name" xModel="editData.name" />
                                <x-admin.component.textinput title="Harga Paket" placeholder="Masukkan harga Paket..." name="price" xModel="editData.price" />
                                <x-admin.component.textareainput title="Deskripsi Paket" placeholder="Masukkan..." name="desc" xModel="editData.desc" />
                            </div>
