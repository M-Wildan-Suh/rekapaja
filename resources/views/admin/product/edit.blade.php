<x-app-layout title="Admin - Edit Usaha">
    ...
    <div class="fixed z-30 right-0 top-20 flex flex-col gap-2">
        <a href="{{ route('detail', ['slug' => $product->slug]) }}" target="_blank">
            <button class="rounded-l-full w-10 h-10 bg-[#ff7100] hover:opacity-60 duration-300 p-2">
        ...
        <a href="{{ route('product.download-domain', ['product' => $product->id]) }}">
            <button class="rounded-l-full w-10 h-10 bg-[#16a34a] hover:opacity-60 duration-300 p-2">
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 16a1 1 0 0 1-.707-.293l-4-4 1.414-1.414L11 12.586V4h2v8.586l2.293-2.293 1.414 1.414-4 4A1 1 0 0 1 12 16Z" fill="#ffffff"></path><path d="M5 18h14v2H5z" fill="#ffffff"></path></svg>
            </button>
        </a>
    </div>
</x-app-layout>
