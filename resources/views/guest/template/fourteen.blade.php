                                ...
                                <div class=" flex flex-col w-full bg-[#1D1616] text-white rounded-md overflow-hidden shadow-md shadow-[#1D1616]/20">
                                    ...
                                    <div class=" flex-grow w-full p-3 flex flex-col justify-between gap-2 text-center">
                                        ...
                                        <div class="w-full flex flex-row flex-wrap items-center justify-center gap-2">
                                            <x-guest.product.detail-button :item="$item" class="duration-300 rounded-md py-1 px-3 text-sm bg-[#8E1616] cursor-pointer border-2 border-white hover:opacity-80" />
