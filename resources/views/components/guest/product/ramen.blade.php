@php
    ...
    $ramenWhatsapp = $template->contact_main_color ?? '#3EA648';
@endphp
...
<div class="w-full max-w-[600px] mx-auto px-4 md:px-0 relative space-y-6">
    <div
        ...
        class="w-full"
    >
        <div x-show="showQrisSection" x-cloak class="rounded-md border px-5 py-5 sm:px-6 shadow-[0_10px_30px_rgba(93,49,30,0.08)]" style="border-color: {{ $ramenBorder }}; background-color: {{ $ramenSurface }};">
        ...
        <form id="myForm" action="{{ route('order', ['no_tlp' => $no_tlp]) }}" method="post" enctype="multipart/form-data" target="_blank" x-ref="orderForm">
            ...
            <div class="grid grid-cols-2 gap-4 sm:grid-cols-3">
                @foreach ($data->productHighlight->take(3) as $item)
                    <div class="overflow-hidden rounded-md border bg-white shadow-[0_10px_30px_rgba(93,49,30,0.1)]" style="border-color: {{ $ramenBorder }};">
                        <div class="relative">
