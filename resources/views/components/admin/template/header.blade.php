        ...
        <div @click.away="header = false" class="w-full max-w-[720px] bg-white pb-6 rounded-md flex flex-col gap-4 relative overflow-hidden border-2 border-byolink-1">
            ...
            <div class="w-full px-4 sm:px-6 h-[309px] sm:h-[292px] overflow-auto">
                <div class=" w-full grid grid-cols-2 sm:grid-cols-3 gap-4">
                    ...
                    <label class="w-full rounded-md aspect-[2/1] overflow-hidden relative">
                        <input type="radio" name="header" value="donuts" class="hidden peer" {{ $selectedHeader === 'donuts' ? 'checked' : '' }}>
                        <img src="{{asset('/assets/images/template/header/donuts.png')}}" class=" w-full h-full object-cover object-center" alt="">
                        <div class=" absolute inset-0 peer-checked:bg-black/50 duration-300">
                        </div>
                    </label>
                </div>
                ...
                <div class=" px-4 sm:px-6 w-full flex justify-end items-center gap-4">
                    ...
                    <script>
                        function changeheader() {
                            ...
                            const headerDonutsPreview = document.getElementById("header-donuts-preview");
                            ...
                            if (headerInput.value === 'ramen') {
                                ...
                                headerDonutsPreview?.classList.add('hidden');
                                return;
                            }

                            if (headerInput.value === 'donuts') {
                                headerShow.src = `/assets/images/template/header/donuts.png`;
