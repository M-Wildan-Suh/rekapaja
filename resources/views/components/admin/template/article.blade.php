                    ...
                    <div class="w-full">
                        <div class="flex flex-col gap-2 text-sm sm:text-base font-medium">
                            ...
                            <div class="w-full grid grid-cols-2 gap-2">
                                ...
                                <label class="w-full rounded-md bg-white overflow-hidden relative flex items-center p-2 justify-center text-center">
                                    <p>Donuts</p>
                                    <input type="radio" name="desc_type" value="donuts" class="hidden peer" {{ $selectedDescType === 'donuts' ? 'checked' : '' }}>
                                    <div class="absolute inset-0 peer-checked:bg-black/50 duration-300"></div>
                                </label>
                            </div>
                        </div>
                ...
                <div class=" px-4 sm:px-6 w-full flex justify-end items-center gap-4">
                    ...
                    <script>
                        function changedesc() {
                            ...
                            const donutsPreview = document.getElementById('desc-donuts-preview');
                            ...
                            if (donutsPreview) {
                                donutsPreview.style.backgroundColor = descmain.value;
                                donutsPreview.style.color = desctext.value;
                            }
