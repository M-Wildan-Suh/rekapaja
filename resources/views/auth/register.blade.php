<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mb-4">
            <x-input-label for="voucher" value="Kode Voucher" />
            <x-text-input id="voucher" class="block mt-1 w-full" type="text" name="voucher" :value="old('voucher')" maxlength="64" required />
