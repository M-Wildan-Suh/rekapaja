...
class TemplateController extends Controller
{
    ...
    private function templateValidationRules(bool $isStore): array
    {
        ...
        return [
            ...
            'header' => ['required', 'in:one,two,three,four,ramen,donuts'],
            'gallery' => ['required', 'in:square,potrait,donuts'],
            'accent_color' => $colorRule,
            'desc_type' => ['required', 'in:default,ramen,donuts'],
            'desc_main_color' => $colorRule,
            'desc_text_color' => $colorRule,
            'product_type' => ['required', 'in:grid,list,ramen,donuts'],
