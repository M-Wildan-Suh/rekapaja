...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 23, 2026 at 05:08 AM
...
--
-- Table structure for table `no_handphones`
--
...
--
-- Dumping data for table `no_handphones`
--
...
--
-- Table structure for table `pivot_product_categories`
--
...
--
-- Dumping data for table `pivot_product_categories`
--
...
--
-- Table structure for table `pivot_product_tags`
--
...
--
-- Dumping data for table `pivot_product_tags`
--
...
--
-- Indexes for table `no_handphones`
--
...
--
-- Indexes for table `pivot_product_categories`
--
...
--
-- Indexes for table `pivot_product_tags`
--
...
--
-- AUTO_INCREMENT for table `no_handphones`
--
ALTER TABLE `no_handphones`
...
--
-- AUTO_INCREMENT for table `pivot_product_categories`
--
ALTER TABLE `pivot_product_categories`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;

--
-- AUTO_INCREMENT for table `pivot_product_tags`
--
ALTER TABLE `pivot_product_tags`
...
--
-- Constraints for table `pivot_product_categories`
--
ALTER TABLE `pivot_product_categories`
...
--
-- Constraints for table `pivot_product_tags`
--
ALTER TABLE `pivot_product_tags`
